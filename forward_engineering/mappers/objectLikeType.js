/**
 * @import {FEStatement, ObjectLikeDefinition, ObjectLikeDefinitionsSchema, IdToNameMap} from "../../shared/types/types"
 */
 ...
 *
 * @param {object} param0
 * @param {ObjectLikeDefinitionsSchema} param0.objectTypes - The object-like types to get.
 ...
 * @param {ObjectLikeDefinition} param0.objectType - The object-like type definition object.
 * @param {IdToNameMap} param0.definitionsIdToNameMap - The definitions id to name map.
 * @param {string} param0.typeKeyword - The type keyword ("type", "interface", "input").
 * @param {Function} param0.getFieldsFunction - The function to get fields for the type.
 * @returns {FEStatement}
